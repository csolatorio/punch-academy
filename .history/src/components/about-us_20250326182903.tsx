        ...
        <div className="md:col-span-2">
          <div className="max-w-7xl mx-auto p-6">
            ...
            <p className="text-gray-600 mb-6 text-lg md:text-base">
              Investing in our people means investing in our future. Our
              wellness programs build stronger teams, foster deeper connections,
              and push limits for personal and professional growth.
            </p>
          </div>
