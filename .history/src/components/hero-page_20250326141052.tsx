  ...
  return (
    <div className="relative w-full h-screen bg-center text-white">
      ...
      <section className="relative w-full h-screen flex items-center justify-start bg-[#D9D9D9]">
        ...
        />
        <div className="relative max-w-2xl text-[#1E1E1E] text-left p-8 ml-12">
          ...
          <a
            href="#"
            className="bg-black text-white px-12 py-5 text-lg font-semibold rounded-md hover:bg-gray-800 transition"
          >
            Learn More
          </a>
        </div>
